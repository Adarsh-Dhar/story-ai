...
export async function getGeminiResponse(messages: Message[]) {
  ...
  if (!OPENROUTER_API_KEY) {
    ...
    return {
      ...
      message: {
        role: 'assistant',
        content: `This is a mock response for development. You asked: "${userQuestion}". In production, this would be answered by the Gemini model. Please set the OPENROUTER_API_KEY environment variable to use the actual API.`
      },
